...
function FeaturedCarousel() {
  ...
  return (
      ...
      <div style={{...contentStyle,backgroundImage:`url(${FM1})`,}}>
        <Container>
            <Row style={{height:"calc(100vh - 70px)"}} align='middle'>
                <Col span={12}>
                    <Flex gap='small' align='center' style={{color:'black' ,backgroundColor:'white',padding:50}} vertical justify='center'>
    ...
    <div>
      <div style={{...contentStyle,backgroundImage:`url(${FM2})`,backgroundPosition:"bottom"}}>
      <Container>
            <Row style={{height:"calc(100vh - 70px)"}} align='middle' justify='end'>
                <Col span={12}>
                    <Flex gap='small' align='center' style={{color:'black' ,backgroundColor:'white',padding:50}} vertical justify='center'>
                    <div style={{padding:8, color:'white', backgroundColor:'red'}}>
                      <h3>BEST TOP SELLER</h3>
